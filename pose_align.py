...
pose3 = np.loadtxt("gt/pose2.txt")[:, 3::4]
pose3 = np.transpose(pose3, (1, 0))
pose3_test = np.loadtxt("result/pose2_test.txt")[:, 3::4]
...
poses_result = load_poses_from_txt("result/pose2_test.txt")
...
np.savetxt("result/pose2_te.txt", poses, delimiter=' ', fmt='%1.8e')

# evo_traj kitti result/pose2_test.txt --ref gt/pose2.txt -p --plot_mod=xy -as ** Please tell me who you are. Run git
